...
### Supabase CLI (Windows / без глобальной установки)

Глобальная команда `supabase` не нужна. Из корня проекта:
...
Или короткие скрипты: `pnpm run db:link`, `pnpm run db:push`.
